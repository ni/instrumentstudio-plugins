...
3. Add your logic/implementation to the top-level plug-in VI. By default, the VI shows off some of
   ...
   ![Top-level plug-in VI Block diagram](./images/InstrumentStudio%20Plug-In%20Guide/Main%20VI%20Block%20diagram.png)

Note: TODO: add link to the document explaing the gplugin components
...
Note: TODO: add link to recommended PPL settings
